...
# against fib(26) which is roughly a user time of 0m0.264s. The time will vary 
...
.ent fib
fib:
beq $a0, 0, fib_base_case
beq $a0, 1, fib_base_case
li $t0, 0       #int a
li $t1, 1       #int b
li $v0, 0       #result we're returning
li $t2, 2       #int i

fib_for:
bgt $t2, $a0, fib_return
addi $t2, $t2, 1
add $v0, $t1, $t0
move $t0, $t1
move $t1, $v0
